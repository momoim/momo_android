...
public class DrmRightsManager {
     ...
     */
    public synchronized DrmRights installRights(InputStream rightsData, int len, String mimeTypeStr)
        ...
        if (DRM_MIMETYPE_RIGHTS_XML_STRING.equals(mimeTypeStr))
            ...
            throw new IllegalArgumentException(
                    "mimeType must be DRM_MIMETYPE_RIGHTS_XML or DRM_MIMETYPE_RIGHTS_WBXML or DRM_MIMETYPE_MESSAGE");
     ...
     * @param mimeType the mime type of this DRM rights object. the value of
     *            this field includes: #DRM_MIMETYPE_RIGHTS_XML
     *            #DRM_MIMETYPE_RIGHTS_WBXML
     * @parma rights the instance of DRMRights to be filled.
     * @return #JNI_DRM_SUCCESS if succeed. #JNI_DRM_FAILURE if fail.
     */
    private native int nativeInstallDrmRights(InputStream data, int len, int mimeType,
            DrmRights rights);
     ...
     * 
     * @return the number of the rights object. #JNI_DRM_FAILURE if fail.
     */
     ...
     * @return the number of the rights object has been gotten. #JNI_DRM_FAILURE
     *         if fail.
     */
