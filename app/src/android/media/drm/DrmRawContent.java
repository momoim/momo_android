...
public class DrmRawContent {
     ...
     */
    public DrmRawContent(InputStream inRawdata, int len, String mimeTypeStr) throws DrmException,
            IOException {
        int mimeType;
        ...
        if (DRM_MIMETYPE_MESSAGE_STRING.equals(mimeTypeStr))
            ...
            throw new IllegalArgumentException(
                    "mimeType must be DRM_MIMETYPE_MESSAGE or DRM_MIMETYPE_CONTENT");
     ...
     * @param mimeType the mime type of this DRM content. the value of this
     *            field includes: #DRM_MIMETYPE_MESSAGE #DRM_MIMETYPE_CONTENT
