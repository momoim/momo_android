...
public class QuickAction extends PopupWindows implements OnDismissListener {
     ...
     */
    public void show(View anchor, View top) {
        preShow();
        ...
        int screenWidth = (top == null ? mWindowManager.getDefaultDisplay().getWidth() : top
                .getWidth());
        int screenHeight = (top == null ? mWindowManager.getDefaultDisplay().getHeight() : top
                .getHeight());
