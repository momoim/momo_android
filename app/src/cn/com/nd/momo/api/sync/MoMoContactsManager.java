...
public class MoMoContactsManager {
    ...
    public void getAllDisplayContactsList(List<Contact> contactList, List<Contact> moList) {
        ...
        ArrayList<Long> moContatIdList = new ArrayList<Long>();
        if (contactMap.size() > 0) {
            ...
            IgnoreMobilePrefix ignoreObject = CardManager.getInstance().getIgnoreObject(
                    Utils.getContext());
            List<Contact> list = loadAllContactPhoneList();
            for (Contact contact : list) {
                ...
                for (String phone : phoneList) {
                    ...
                    if (phone == null || phone.length() < 1) {
                        ...
                        if (!moContatIdList.contains(contactId)) {
                            moContatIdList.add(contactId);
                        }
                        break;
                    }
                }
    ...
    /**
     * 根据电话号码查找对应的联系人，若有号码相同的联系人，随机返回其中的一个。
     * 
     * @param uid
     * @retur 对应的联系人
     */
    public Contact getContactByPhoneNumber(String phoneNumber) {
        return LocalContactsManager.getInstance().getContactByMobile(phoneNumber);
    }
