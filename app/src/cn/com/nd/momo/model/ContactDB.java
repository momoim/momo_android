...
public class ContactDB {
    ...
    public String parsePhoneNumber(String phoneNumber) {
        ...
        return new String(dst, 0, index);

    }

    public ArrayList<String> loadAllMobile() {
        ...
        for (Contact c : contacts) {
            ...
            for (Contact.ContactData number : c.phoneNumbers) {
                mobiles.add(parsePhoneNumber(number.value));
            }
        }
        return mobiles;
    }
