...
import android.media.drm.DrmRawContent;
import android.media.drm.DrmRights;
import android.media.drm.DrmRightsManager;
...
public class DrmWrapper {
     ...
     * Consume the rights.
     * 
     * @return true if consume success false if consume failure
     */
     ...
     * download it.
     * 
     * @return true if it is existed false if not
     */
     ...
     * 
     * @return true if this object can be forwarded false if not
     */
