...
/**
 * The NotificationTransaction is responsible for handling multimedia message
 * notifications (M-Notification.ind). It:
 * <ul>
 ...
 * retrieval</b> response. The transaction service, upon succesful completion of
 * this transaction, will trigger a retrieve transaction in case the client is
 * in immediate retrieve mode.
 */
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public void run() {
        ...
        boolean dataSuspended = (MyApplication.getApplication().getTelephonyManager()
                .getDataState() ==
