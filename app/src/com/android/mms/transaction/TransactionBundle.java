...
public class TransactionBundle {
    /**
     * Key for the transaction-type. Allowed values for this key are:
     * TYPE_PUSH_TRANSACTION, TYPE_RETRIEVE_TRANSACTION, TYPE_SEND_TRANSACTION,
     * and TYPE_READREC_TRANSACTION.
     */
    public static final String TRANSACTION_TYPE = "type";

    /**
     * Key of the push-data. Used when TRANSACTION_TYPE is
    ...
    /**
     * Key of the URI. Indicates the URL of the M-Retrieve.conf in
     * TYPE_RETRIEVE_TRANSACTION, or the Uri of the M-Send.req/M-Read-Rec.ind in
     * TYPE_SEND_TRANSACTION and TYPE_READREC_TRANSACTION, respectively.
     */
     ...
     * TYPE_RETRIEVE_TRANSACTION, TYPE_SEND_TRANSACTION, and
     * TYPE_READREC_TRANSACTION.
     * 
     * @param transactionType
     * @param uri The relevant URI for this transaction. Indicates the URL of
     *            the M-Retrieve.conf in TYPE_RETRIEVE_TRANSACTION, or the Uri
     *            of the M-Send.req/M-Read-Rec.ind in TYPE_SEND_TRANSACTION and
