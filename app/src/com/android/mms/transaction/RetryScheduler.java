...
public class RetryScheduler implements Observer {
    ...
    private boolean isConnected() {
        ...
        return (mConnMgr.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).isConnected());
    }
    ...
    private void scheduleRetry(Uri uri) {
        ...
        Cursor cursor = mContext.getContentResolver().query(uriBuilder.build(), null, null, null,
                null);
            ...
            try {
                if ((cursor.getCount() == 1) && cursor.moveToFirst()) {
                    ...
                    int retryIndex = cursor.getInt(cursor.getColumnIndexOrThrow(
                            PendingMessages.RETRY_INDEX)) + 1; // Count this
                                                               // time.
                    ...
                    if ((retryIndex < scheme.getRetryLimit()) && retry) {
                        ...
                        if (isRetryDownloading) {
                            ...
                            if (threadId != -1) {
                                ...
                                // MessagingNotification.notifyDownloadFailed(mContext,
                                // threadId);
                            }
    ...
    private int getResponseStatus(long msgID) {
        int respStatus = 0;
        Cursor cursor = mContentResolver.query(Mms.Outbox.CONTENT_URI, null, Mms._ID + "=" + msgID,
                null, null);
        try {
