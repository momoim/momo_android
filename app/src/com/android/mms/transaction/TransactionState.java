...
/**
 * TransactionState intends to encapsulate all the informations which would be
 * known by the observers of transactions. To encapsulate Transaction- State
 * into an intent, it should implement Parcelable interface.
 */
public class TransactionState {
    ...
    /**
     * To represent the current state(or the result of processing) to the ones
     * who wants to know the state.
     * 
    ...
    /**
     * To set the state of transaction. This method is only invoked by the
     * transactions.
     * 
