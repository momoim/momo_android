...
import com.android.mms.data.Telephony.MmsSms.PendingMessages;
...
import com.android.mms.util.NetworkConnectivityListener;
...
public class TransactionService extends Service implements Observer {
    ...
    private void stopSelfIfIdle(int startId) {
        synchronized (mProcessing) {
            if (mProcessing.isEmpty() && mPending.isEmpty()) {
                // Make sure we're no longer listening for connection state
                // changes.
    ...
    /**
     * TODO I don't know TYPE_MOBILE is contain TYPE_MOBILE_MMS or not
     * 
     * @return
     */
    private boolean isNetworkAvailable() {
        return true;
        // return mConnMgr.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).
        // isAvailable();
    }
                ...
                case TransactionState.SUCCESS:
                    ...
                    switch (transaction.getType()) {
                        ...
                        case Transaction.RETRIEVE_TRANSACTION:
                            ...
                            // NotificationTransacation.run(), so ok to block
                            // here.
                            ...
                            // break;
                            // TODO: notify success retrieve mms's content
                            Log.d(TAG, "success get mms'content");
    ...
    protected int beginMmsConnectivity() throws IOException {
        ...
        // TODO: I confuse here to replace TYPE_MOBILE_MMS with TYPE_MOBILE
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case EVENT_DATA_STATE_CHANGED:
                    /*
                     * If we are being informed that connectivity has been
                     * established to allow MMS traffic, then proceed with
                     * processing the pending transaction, if any.
                     */
