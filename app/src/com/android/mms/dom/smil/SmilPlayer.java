...
/**
 * The SmilPlayer is responsible for playing, stopping, pausing and resuming a
 * SMIL tree. <li>It creates a whole timeline before playing.</li> <li>The
 * player runs in a different thread which intends not to block the main thread.
 * </li>
 */
public class SmilPlayer implements Runnable {
    ...
    private static ArrayList<TimelineEntry> getParTimeline(
         ...
         * @see
         * com.android.mms.dom.smil.ElementParallelTimeContainerImpl#getBegin()
         */
         ...
         * @see
         * com.android.mms.dom.smil.ElementParallelTimeContainerImpl#getEnd()
         */
    ...
    private static ArrayList<TimelineEntry> getSeqTimeline(
         ...
         * Begin list only contain 1 begin time which has been resolved.
         * @see
         * com.android.mms.dom.smil.ElementSequentialTimeContainerImpl#getBegin
         * ()
         */
        Time begin = myBeginList.item(0);
        double beginOffset = begin.getResolvedOffset() + offset;
         ...
         * End list only contain 1 end time which has been resolved.
         * @see
         * com.android.mms.dom.smil.ElementSequentialTimeContainerImpl#getEnd()
         */
        Time end = myEndList.item(0);
        double endOffset = end.getResolvedOffset() + offset;
        if (endOffset > maxOffset) {
        ...
        for (int i = 0; i < children.getLength(); ++i) {
            ...
            // Since the child timeline has been sorted, the offset of the last
            // one is the biggest.
    ...
    private static final class TimelineEntry {
        ...
        public String toString() {
            return "Type = " + mElement + " offset = " + getOffsetTime() + " action = "
                    + getAction();
        }
    }
