...
public abstract class ElementTimeImpl implements ElementTime {
    ...
    /**
     * To get the parent node on the ElementTime tree. It is in opposition to
     * getTimeChildren.
     * 
     * @return the parent ElementTime. Returns <code>null</code> if there is no
     *         parent.
     */
    ...
    public TimeList getBegin() {
        ...
        // TODO: Check other constraints on parsed values, e.g., "single,
        ...
        if (beginTimeList.size() == 0) {
            /*
             * What is the right default value? In MMS SMIL, this method may be
             * called either on an instance of: 1 -
             * ElementSequentialTimeContainer (The SMILDocument) 2 -
             * ElementParallelTimeContainer (A Time-Child of the SMILDocument,
             * which is a seq) 3 - ElementTime (A SMILMediaElement). 1 - In the
             * first case, the default start time is obviously 0. 2 - In the
             * second case, the specifications mentions that "For children of a
             * sequence, the only legal value for begin is a (single)
             * non-negative offset value. The default begin value is 0." 3 - In
             * the third case, the specification mentions that
             * "The default value of begin for children of a par is 0." In
             * short, if no value is specified, the default is always 0.
             */
    ...
    public TimeList getEnd() {
        ...
        if (!((len == 1) && (endTimeStringList[0].length() == 0))) { // Ensure
                                                                     // the end
                                                                     // field is
                                                                     // set.
            // Initialize Time instances and add them to Vector
    ...
    public short getFill() {
        ...
        if (fill.equalsIgnoreCase(FILL_FREEZE_ATTRIBUTE)) {
            ...
            /*
             * fill = default The fill behavior for the element is determined by
             * the value of the fillDefault attribute. This is the default
             * value.
             */
        ...
        /*
         * fill = auto The fill behavior for this element depends on whether the
         * element specifies any of the attributes that define the simple or
         * active duration: - If none of the attributes dur, end, repeatCount or
         * repeatDur are specified on the element, then the element will have a
         * fill behavior identical to that if it were specified as "freeze". -
         * Otherwise, the element will have a fill behavior identical to that if
         * it were specified as "remove".
         */
    ...
    public short getFillDefault() {
        ...
        if (fillDefault.equalsIgnoreCase(FILL_REMOVE_ATTRIBUTE)) {
            ...
            /*
             * fillDefault = inherit Specifies that the value of this attribute
             * (and of the fill behavior) are inherited from the fillDefault
             * value of the parent element. This is the default value.
             */
            ElementTime parent = getParentElementTime();
            if (parent == null) {
                /*
                 * fillDefault = auto If there is no parent element, the value
                 * is "auto".
                 */
                return FILL_AUTO;
            } else {
    ...
    public void setDur(float dur) throws DOMException {
        // In SMIL 3.0, the dur could be a timecount-value which may contain
        // fractions.
        // However, in MMS 1.3, the dur SHALL be expressed in integer
        // milliseconds.
