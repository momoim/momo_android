...
public class SmilDocumentImpl extends DocumentImpl implements SMILDocument, DocumentEvent {
    /*
     * The sequential time container cannot be initialized here because the real
     * container is body, which hasn't been created yet. It will be initialized
     * when the body has already been created. Please see getBody().
     */
