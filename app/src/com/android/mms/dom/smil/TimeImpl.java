...
public class TimeImpl implements Time {
    ...
    /**
     * Creates a TimeImpl representation of a time-value represented as a
     * String. Time-values have the following syntax:
     * <p>
     * 
     * <pre>
    ...
    TimeImpl(String timeValue, int constraints) {
        /*
         * We do not support yet: - smil-1.0-syncbase-value - syncbase-value -
         * syncToPrev-value - event-value - Media-marker-value -
         * Wallclock-sync-value
         */
     ...
     * @throws IllegalArgumentException if Decimal was not expected but
     *             encountered
     */
