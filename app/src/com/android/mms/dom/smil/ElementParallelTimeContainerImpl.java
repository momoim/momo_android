...
public abstract class ElementParallelTimeContainerImpl extends ElementTimeContainerImpl
    ...
    public NodeList getActiveChildrenAt(float instant) {
        /*
         * Find the closest Time of ElementTime before instant. Add ElementTime
         * to list of active elements if the Time belongs to the begin-list, do
         * not add it otherwise.
         */
