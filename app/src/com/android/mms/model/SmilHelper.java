        ...
        for (SlideModel slide : slideshow) {
            ...
            for (MediaModel media : slide) {
                ...
                if (media instanceof TextModel) {
                    ...
                    sme = SmilHelper
                            .createMediaElement(SmilHelper.ELEMENT_TAG_IMAGE, document, src);
                    ...
                    sme = SmilHelper
                            .createMediaElement(SmilHelper.ELEMENT_TAG_VIDEO, document, src);
                    imgRegionPresentInLayout = setRegion((SMILRegionMediaElement)sme,
                            smilRegions,
                            layoutElement,
                            LayoutModel.IMAGE_REGION_ID,
                    ...
                    sme = SmilHelper
                            .createMediaElement(SmilHelper.ELEMENT_TAG_AUDIO, document, src);
                } else {
