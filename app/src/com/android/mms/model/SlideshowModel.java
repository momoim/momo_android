...
import android.media.drm.DrmException;
import android.net.Uri;
import android.text.TextUtils;
import android.widget.Toast;
import cn.com.nd.momo.api.util.Log;

import com.android.mms.data.ContentType;
import com.android.mms.dom.smil.parser.SmilXmlSerializer;
import com.android.mms.drm.DrmWrapper;
import com.android.mms.exception.ContentRestrictionException;
import com.android.mms.exception.ExceedMessageSizeException;
...
public class SlideshowModel extends Model
    ...
    /**
     * Resize all the resizeable media objects to fit in the remaining size of
     * the slideshow. This should be called off of the UI thread.
     * 
    ...
    public void finalResize(Uri messageUri) throws MmsException, ExceedMessageSizeException {
        // Log.v(TAG, "Original message size: " + getCurrentMessageSize() +
        // " getMaxMessageSize: "
        // + MmsConfig.getMaxMessageSize());

        // Figure out if we have any media items that need to be resized and
        // total up the
        ...
        if (resizableCnt > 0) {
            // int remainingSize = MmsConfig.getMaxMessageSize() -
            // fixedSizeTotal - SLIDESHOW_SLOP;
            // TODO: 读取一个会话中最大的短信数
            int remainingSize = 200 - fixedSizeTotal - SLIDESHOW_SLOP;
            if (remainingSize <= 0) {
            ...
            // Log.v(TAG, "New message size: " + totalSize +
            // " getMaxMessageSize: "
            // + MmsConfig.getMaxMessageSize());
