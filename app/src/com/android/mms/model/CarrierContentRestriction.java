...
import com.android.mms.exception.ResolutionException;
import com.android.mms.exception.UnsupportContentTypeException;
...
public class CarrierContentRestriction implements ContentRestriction {
    ...
    public void checkResolution(int width, int height) throws ContentRestrictionException {
        // TODO: 配置
        // if ((width > MmsConfig.getMaxImageWidth()) || (height >
